...
- name: Microsoft Graph API - Get Format Protection
  x-api-slug: workbooknamesltnamegtrangeformatprotection-get
...
- name: Microsoft Graph API - Get Format Protection
  x-api-slug: workbookworksheetsltidnamegtrangeltaddressgtformatprotection-get
  description: Get FormatProtection Retrieve the properties and relationships of formatprotection
    object.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
...
- name: Microsoft Graph API - Get Format Protection
  x-api-slug: workbooktablesltidnamegtcolumnsltidnamegtrangeformatprotection-get
  description: Get FormatProtection Retrieve the properties and relationships of formatprotection
    object.
  image: http://kinlane-productions.s3.amazonaws.com/api-evangelist-site/company/logos/microsoft-graph.png
  humanURL: https://developer.microsoft.com/en-us/graph/
